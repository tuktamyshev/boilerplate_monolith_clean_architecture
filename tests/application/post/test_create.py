...
from tests.factories.entities import UserEntityFactory, PostEntityFactory
...
class TestCreatePostUseCase:
    ...
    async def test_create_post_success(self):
        ...
        self.user_notificator.notify_new_post.assert_awaited_once_with(data=NotifyNewPostDTO(**post_entity.model_dump()))
